    ...
    void Print(DoWhatToProbe whattoprint) {
            ...
            switch (whattoprint)
            {
                ...
                case print_duration:        // run time report
                    ...
                    f = (float)duration.avg / (float)(SystemCoreClock/1000000);   // average time, in [us]. Duration comes in [mc]
                    #else   
                    ...
                    #elif ARDUINO_ARCH_STM32U5
                    STDOUT.print ("min:"); STDOUT.print((float)duration.min / (float)(SystemCoreClock/1000000)); STDOUT.print(" ");
                    STDOUT.print ("max:"); STDOUT.print((float)duration.max / (float)(SystemCoreClock/1000000)); STDOUT.print(" ");
                    STDOUT.print ("now:"); STDOUT.print((float)duration.val / (float)(SystemCoreClock/1000000));
                    #else
...
public:
    ...
    #ifdef X_PROBECPU
        #if defined(ARDUINO_ARCH_STM32L4) || defined(ARDUINO_ARCH_STM32U5)  // STM architecture
