...
#define I2CLOCK() do {							\
  ...
  attachInterrupt(digitalPinToInterrupt(motionSensorInterruptPin), motion_irq, RISING);
	...
	first_motion_ = false;
      ...
      #endif
      I2CLOCK();
      I2C_WRITE_BYTE_ASYNC(CTRL7_G, 0b10000000);  // accel disable
      I2C_WRITE_BYTE_ASYNC(CTRL2_G, 0x0);  // accel disable

      I2C_WRITE_BYTE_ASYNC(CTRL6_C, 0b00010000);  // accel disable
      I2C_WRITE_BYTE_ASYNC(CTRL1_XL, 0x0);  // accel disable
