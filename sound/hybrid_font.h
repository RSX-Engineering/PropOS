...
public:
  ...
  void SB_Effect(EffectType effect, float location) override {
	...
	// If no stab sounds are found, fall through to clash
      ...
      case EFFECT_CONNECT: emojiSounds.Select(emojiSounds_id::connected-1); PlayPolyphonic(&emojiSounds); return;
      case EFFECT_DISCONNECT: emojiSounds.Select(emojiSounds_id::disconnected-1); PlayPolyphonic(&emojiSounds); return;
