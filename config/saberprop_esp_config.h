...
#ifndef SABERPROP_ESP_CONFIG_HW
#define SABERPROP_ESP_CONFIG_HW
    ...
    enum SaberPins {
        ...
        txd0Pin = 6,             // NOT USED ON HW TODO // TXD0 (digital audio)   PA10  was = 26
        lrclkPin = 4,            //
        ...
        sdCardPowerPin = 48,               // IO48 = enable SD CARD power


        amplifierPin = 46, //21,            // Amplifier and booster enable pin IO46
        boosterPin = INVALID_PIN,           // same as amplifierPin
        ...
        // Neopixel pins
        pixelPowerPin = 17,             // IO17 for swBAT (pixel power) control
        bladePin = 11,                  // blade control, either WS2811 or PWM PA0
        ...
        #ifdef ESP_S3_WROOM
        chargeDetectPin = 41,            // charge detect
        #else 
        chargeDetectPin = 26,            // charge detect
        #endif
        // #define ESP_S3_R8COMP   // ESP32-S3 R8 compatible (white SaberProp boards and newer)
        #ifndef ESP_S3_R8COMP
        chargeCurrentPin = 47,           // charge current (0=0.85A, 1=1.0A) 
        #endif
        chargeEnablePin =  21,           // charge enable
